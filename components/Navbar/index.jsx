    ...
    <nav className="pt-0 flex justify-between items-center lg:pt-2">
            ...
            <h2 title="Hogar Menacho - Cerca de ti">
              <Link href="/">
                <a className="flex flex-col justify-center items-center gap-0">
                  <MdOutlineDeliveryDining className="text-4xl text-rose-600" />
        ...
        <div>
          <ul className={`menu hidden absolute left-0 top-0 px-3 pb-6 pt-20 bg-black w-full sm:w-unst sm:bg-transparent sm:p-0 sm:static sm:flex sm:justify-center sm:items-center sm:gap-4 ${styles.menu} ${navOpen ? `${styles.open}` : ""}`}>
            <li className="text-white mb-3 font-semibold ease-in-out duration-150 hover:text-rose-600 w-max sm:mb-0 sm:text-black" title="Home" onClick={() => closeNav()}>
              <Link href="/">Inicio</Link>
            </li>
            <li className="text-white mb-3 font-semibold ease-in-out duration-150 hover:text-rose-600 w-max sm:mb-0 sm:text-black" title="About Us" onClick={() => closeNav()}>
              <Link href="/about-us">Nosotros</Link>
            </li>
            <li className="text-white mb-3 font-semibold ease-in-out duration-150 hover:text-rose-600 w-max sm:mb-0 sm:text-black" title="Menu" onClick={() => closeNav()}>
              <Link href="/menu">Productos</Link>
            </li>
            <li className="text-white font-semibold ease-in-out duration-150 hover:text-rose-600 sm:text-black" title="Contact Us" onClick={() => closeNav()}>
